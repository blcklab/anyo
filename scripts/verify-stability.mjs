...
const expectedSekaiBridge = `Sekai64CameraAdapter Sekai64FrameDriver Sekai64Renderer Sekai64ResourceAdapter Sekai64ResourceAdapterError Sekai64XRBridge createSekai64RendererResourceAdapter createSekai64ResourceAdapter createSekai64ResourceAdapterFromNativeAccess toSekaiTextOptions`.split(' ').sort()
